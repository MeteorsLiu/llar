...
func TestNewFormulaModule(t *testing.T) {
	...
	mod := newFormulaModule(fsys, "DaveGamble/cJSON", classfile.Matrix{}, nil)
...
func TestFormulaModule_ComparatorDefaultFallback(t *testing.T) {
	...
	mod := newFormulaModule(fsys, "madler/zlib", classfile.Matrix{}, nil)
...
func TestFormulaModule_AtReturnsIsolatedClasses(t *testing.T) {
	mod := newFormulaModule(os.DirFS("testdata/load/towner/targetreq"), "towner/targetreq", classfile.Matrix{}, nil)
...
func TestFormulaModule_AtNonexistentModule(t *testing.T) {
	...
	mod := newFormulaModule(fsys, "nonexistent/module", classfile.Matrix{}, nil)
...
func TestIntegration_MultipleModules(t *testing.T) {
	...
	for _, m := range modules {
		fsys := os.DirFS(m.dir)
		mod := newFormulaModule(fsys, m.path, classfile.Matrix{}, nil)
